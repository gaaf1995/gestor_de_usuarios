...
async function search(){
    ...
    <td>
        <a href="#" onclick="edit(${customer.id})" class="genericButton">Editar</a>
        <a href="#" onclick="remove(${customer.id})" class="deleteButton">Eliminar</a>
    </td>
</tr>`
    html = html + row;
    }
...
async function remove(id){
    respuesta = confirm('¿Estás seguro que deseas eliminarlo?')
    if(respuesta){
